 ...
 * This includes:
 * <p>
 *  - Configuration: A record class that holds the necessary information to establish a database connection such
 *    as the host address, username and password. The class provides a method to read these details from a JSON
