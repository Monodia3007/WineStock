...
/**
 * The Launcher class serves as the entry point to the WineStock JavaFX application.<br/>
 * This class is mainly used to bypass JavaFX 11 module path access restrictions.
 */
public class Launcher {
    /**
     * The main method which serves as the entry point of the application.<br/>
