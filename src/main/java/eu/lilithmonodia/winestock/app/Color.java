...
/**
 * This `Color` enum represents the possible colors of the wine.<br/>
...
public enum Color {
    /**
     * Rouge color represents red wine.
     */
    ROUGE,
    /**
     * Blanc color represents white wine.
     */
    BLANC,
    /**
     * Rosé color represents rosé wine.
     */
    ROSE,
    /**
